...
void SAADC_IRQHandler(void)
{
    ...
    {
        if ((ADC_Counter & 0x03) == 0x00)
        { //VGVG added for accounting for long packets that arent 40 samples long anymore
    ...
    {
        if ((ADC_Counter & 0x01) == 0x00)
        { //The if statement above looks at LSB to see if its a multiple of 2.
